...
class btSoftBodyCollisionCallback
{
    public:
        virtual void CollisionHandlerCallback(const btRigidBody* inRigidBody) = 0;
};
...
//				printf("impulse.m_drift = %f,%f,%f\n",impulse.m_drift.getX(),impulse.m_drift.getY(),impulse.m_drift.getZ());
    ...
    btSoftBodyCollisionCallback* m_customCollisionCallback;
