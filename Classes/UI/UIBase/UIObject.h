...
@interface UIObject : GameObject<PathCallback>
{
    ...
    @public
        ...
        Color           mColorMultiply;
    
        NSMutableArray* mChildren;
}

@property BOOL FadeWhenInactive;
@property(assign) UIObject* Parent;

@property BOOL ColorMultiplyEnabled;
@property Color ColorMultiply;
...
typedef struct
{
    ...
    BOOL     mPositionCoordsEnabled;
    float    mPositionCoords[12];
