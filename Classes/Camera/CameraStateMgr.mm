...
-(void)GetPostProjectionMatrix:(Matrix44*)outPostProjectionTransform
{
    [mCameraStateMachine GetPostProjectionMatrix:outPostProjectionTransform];
}
...
-(void)GetInversePostProjectionMatrix:(Matrix44*)outInversePostProjectionTransform
{
    [mCameraStateMachine GetInversePostProjectionMatrix:outInversePostProjectionTransform];
}
