...
-(void)UpdateLights
{
    int numLights = (int)[mLights count];
...
-(Light*)CreateLight
{
    ...
    BOOL* useArray = (BOOL*)malloc(sizeof(BOOL) * (mMaxGLIdentifier - mMinGLIdentifier + 1));
...
-(void)RemoveLight:(Light*)inLight
{
    ...
    u64 index = [mLights indexOfObject:inLight];
