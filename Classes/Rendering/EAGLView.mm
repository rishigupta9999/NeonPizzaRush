...
- (id)initWithCoder:(NSCoder*)coder
{
	if ((self = [super initWithCoder:coder]))
    {
        ...
        GetAppDelegate().glView = self;
	}
    
    [GLExtensionManager CreateInstance];
    
    [GetGlobalMessageChannel() SendEvent:EVENT_INIT_GL_CONTEXT_CREATED withData:NULL];
...
- (void)destroyFramebuffer 
{
	...
	NeonGLDeleteFramebuffers(1, &mViewFramebuffer);
    ...
    {
        NeonGLDeleteFramebuffers(1, &mMultisampleFramebuffer);
        mMultisampleFramebuffer = 0;
    }
