...
-(void)StartMeshWithOwner:(GameObject*)inOwnerObject
{
...
-(void)SetAttributePointer:(MeshBuilderVertexAttribute*)inAttribute data:(u8*)data numComponents:(u8)inNumComponents numVertices:(u32)inNumVertices copyData:(BOOL)inCopyData
{
    ...
    if (inCopyData)
    {
        inAttribute->mAttributeData = (u8*)malloc(inAttribute->mNumComponentsPerVertex * inAttribute->mNumVertices * sizeof(float));
...
-(void)FinishPass
{
    int numEntries = (int)[mEntries count];
...
-(void)AllocateStreams
{
    if (mPositionStream.mNumComponentsPerVertex > 0)
    {
        ...
        mPositionStream.mAttributeData = (u8*)malloc(mPositionStream.mNumComponentsPerVertex * mPositionStream.mNumVertices * sizeof(float));
    }
    ...
    if (mNormalStream.mNumComponentsPerVertex > 0)
    {
        ...
        mNormalStream.mAttributeData = (u8*)malloc(mNormalStream.mNumComponentsPerVertex * mNormalStream.mNumVertices * sizeof(float));
    }
    ...
    if (mTexcoordStream.mNumComponentsPerVertex > 0)
    {
        ...
        mTexcoordStream.mAttributeData = (u8*)malloc(mTexcoordStream.mNumComponentsPerVertex * mTexcoordStream.mNumVertices * sizeof(float));
    }
    ...
    if (mColorStream.mNumComponentsPerVertex > 0)
    {
        ...
        mColorStream.mAttributeData = (u8*)malloc(mColorStream.mNumComponentsPerVertex * mColorStream.mNumVertices * sizeof(float));
    }
    
    mIndexBuffer = (u16*)malloc(sizeof(u16) * mNumVertices);
}
