...
-(void)SetGlyph:(const char*)inGlyph
{
...
-(void)SetData:(id)inData forGlyph:(const char*)inGlyph type:(CharMapEntryType)inType
{
...
-(CharMapEntry*)CharMapEntryForGlyph:(const char*)inGlyph
{
    return NULL;
}
