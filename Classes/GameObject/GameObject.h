...
@interface GameObject : NSObject
{
    ...
    @private
        ...
        Vector3         mDerivedPositionDelta;
}

@property(atomic, setter=setSoftBody:,  getter=softBody)  btSoftBody*   SoftBody;
@property(atomic, setter=setRigidBody:, getter=rigidBody) btRigidBody*  RigidBody;

@property int   MaxNumRenders;
@property int   NumRenders;
