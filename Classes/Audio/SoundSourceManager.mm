...
{    
    ...
    int numActiveSoundSources = (int)[mActiveSoundSources count];
    ...
    int numInactiveSoundSources = (int)[mInactiveSoundSources count];
...
-(SoundSource*)SoundSourceWithParams:(SoundSourceParams*)inParams
{
    ...
    int numInactiveSounds = (int)[mInactiveSoundSources count];
...
-(void)StopSound:(SoundSource*)inSoundSource
{
    ...
    u64 index = [mActiveSoundSources indexOfObject:inSoundSource];
    NSAssert(index != NSNotFound, @"Sound source not found");
    
    [mActiveSoundSources removeObjectAtIndex:(NSUInteger)index];
