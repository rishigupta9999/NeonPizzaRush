...
typedef enum
{
    ...
    IAP_PRODUCT_BOOSTER = IAP_PRODUCT_NON_CONSUMABLE_FIRST,
    IAP_PRODUCT_NON_CONSUMABLE_NUM,
    IAP_PRODUCT_CONSUMABLE_FIRST = IAP_PRODUCT_NON_CONSUMABLE_NUM,
    IAP_PRODUCT_CONSUMABLE_LAST = IAP_PRODUCT_CONSUMABLE_FIRST,
    IAP_PRODUCT_CONSUMABLE_NUM = IAP_PRODUCT_CONSUMABLE_FIRST,
    IAP_PRODUCT_NUM = IAP_PRODUCT_NON_CONSUMABLE_NUM,
